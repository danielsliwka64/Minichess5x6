...
namespace MiniChessLogic
{
    public class Board
    {
        ...
        private bool IsKingBishopVKingBishop(Counting counting)
        {
            ...
            Position wBishopPos = FindPlace(Player.White, PieceType.Bishop);
            Position bBishopPos = FindPlace(Player.Black, PieceType.Bishop);


            return wBishopPos.SquareColor() == bBishopPos.SquareColor();
        }

        private Position FindPlace(Player color, PieceType type)
        {
